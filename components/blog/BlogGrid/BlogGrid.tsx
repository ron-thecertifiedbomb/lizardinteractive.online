...
// 1. Updated Interface: layoutType removed
interface Post {
    createdAt: string;
    ogImage: string;
    content: {
...
export default function BlogGrid({ posts }: BlogGridProps) {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full">
            {posts.map((post, idx) => {
                const dynamicSlug = getSlug(post.content.header.title);
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                {/* 2. Layout specific stream label removed, replaced with static label */}
