...
export const ModernMinimalistPreview: React.FC<ModernMinimalistPreviewProps> = ({
    ...
    return (
        <div
            className={`modern-minimalist-preview bg-white text-gray-800 p-8 rounded-lg border border-gray-200 ${className}`}
        ...
        >
            ...
            >
                ...
                <div
                    className="flex justify-center flex-wrap gap-4 text-gray-500"
                                ...
                                {experience.map((exp) => (
                                    ...
                                    >
                                        <div className="flex justify-between items-start">
                                            ...
                                            <div
                                                className="text-gray-500 px-3 py-1 rounded-full text-xs whitespace-nowrap"
                        ...
                        <section className="space-y-2">
                            ...
                            >
                                {skills.map((skill, index) => (
                                    <div
                                        key={index}
                                        className="text-start py-1 rounded-lg text-sm font-light "
                                ...
                                {education.map((edu) => (
                                    ...
                                    >
                                        <div className="flex justify-between items-start mb-1">
                                            ...
                                            <div
                                                className="text-gray-500 px-2 py-1 rounded-full text-xs"
                                        ...
                                        {edu.details && (
                                            <div className="mt-2 text-gray-700">{edu.details}</div>
                                        )}
                                    </div>
                                ))}
                            </div>
