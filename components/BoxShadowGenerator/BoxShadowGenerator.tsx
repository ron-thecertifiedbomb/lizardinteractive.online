...
export default function BoxShadowGenerator() {
    ...
    return (
        <div className="px-6 py-2 bg-gray-800 rounded-xl shadow-lg space-y-6 text-white">

            {/* Preview Box */}
            <div className="flex justify-center my-8 px-10">
                <div
                    className="w-full h-40 bg-gray-900 rounded-xl transition-all duration-200"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                ...
                <div className="space-y-4">
                    <label className="block">
                        ...
                        <input type="range" min="-100" max="100" value={hOffset}
                    ...
                    <label className="block">
                        ...
                        <input type="range" min="-100" max="100" value={vOffset}
                    ...
                    <label className="block">
                        Spread: {spread}px
                        <input type="range" min="-50" max="50" value={spread}
            ...
            <button
                ...
                className="w-full mt-3 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-lg"
            >
                Copy CSS
            </button>
        </div>
