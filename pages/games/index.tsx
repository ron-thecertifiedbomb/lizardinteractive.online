        ...
        <div className="min-h-screen w-full bg-black text-white selection:bg-emerald-500 selection:text-black relative z-[1]">
            <ScreenContainer variant="dark" maxWidth="xl">
                ...
                <header className="py-16 border-b border-white/5 mb-12">
                    ...
                    <h1 className="text-6xl font-bold tracking-tighter  uppercase">The Void <span className="text-emerald-500">Arcade</span></h1>
                ...
                {!activeGame ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {GAMES.map((game) => (
                            <div
                                ...
                                className="group relative overflow-hidden border border-white/10 bg-zinc-900/20 p-8 rounded-sm hover:border-emerald-500/50 transition-all duration-500 cursor-pointer"
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="flex justify-between items-start mb-8">
                                        ...
                                        <div className={`h-2 w-2 rounded-full animate-pulse ${game.color === 'emerald' ? 'bg-emerald-500' : 'bg-purple-500'}`} />
                                    </div>
                    ...
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-1000">
                        <div className="flex flex-col md:flex-row justify-between items-end mb-8 gap-4">
                            <div>
                                <span className="font-mono text-xs text-emerald-500 mb-2 block uppercase tracking-widest">Now Streaming</span>
                                <h2 className="text-4xl font-bold italic uppercase">{activeGame.name}</h2>
                            </div>
                            <button
                                onClick={() => setActiveGame(null)}
                                className="font-mono text-[10px] uppercase tracking-[0.2em] px-4 py-2 border border-white/20 hover:bg-white hover:text-black transition-colors"
                            >
                                [ Terminate Session ]
                            </button>
                        </div>

                        <div className="aspect-video w-full bg-zinc-900 border border-white/10 shadow-2xl relative">
                            ...
                            <iframe
                                src={`https://cdn.emulatorjs.org/stable/data/index.html?game=/roms/${activeGame.file}&core=nes`}
